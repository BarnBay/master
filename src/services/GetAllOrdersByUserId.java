...
public class GetAllOrdersByUserId extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		String tables = schema + "BARNBAY bb, " + schema + "CATEGORY cat, "
				...
				+ "USERD customer, " + schema + "PRODUCT prod";
		String where_clause = "customer.username = '"
				+ receiveduser.username
				+ "' AND customer.idUser = o.FK_USERS_CUSTOMER AND prod.fk_category = cat.idCategory "
		...
		if (rs != null) {
			...
			try {
				while (rs.next()) {
					...
					order_json_string = order_json_string + "\"barnbay\" : "
							+ "\"" + rs.getString(1) + "\", "
							...
							+ rs.getString(5) + "\", "
							+ "\"overall_price_per_product\" : \""
							+ overall_price_per_product.toString() + "\", "
