...
public class Initialize extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException {		
		...
		if(schema ==""){
			...
			db.executeSQL("INSERT INTO " + schema + "USERTYPE VALUES(1, 'CUSTOMER')");
			db.executeSQL("INSERT INTO " + schema + "USERTYPE VALUES(1, 'PICKUPLOCATION')");
			db.executeSQL("INSERT INTO " + schema + "USERTYPE VALUES(1, 'BARNBAYFINANCIALS')");
