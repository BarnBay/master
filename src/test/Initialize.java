...
public class Initialize extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException {		
		...
		db.executeSQL("CREATE TABLE TEST.PRODUCT (IDPRODUCT INTEGER, PRODUCT_DESCRIPTION VARCHAR(100), FK_CATEGORY INTEGER, FK_USER INTEGER, PRICE DECIMAL(2,0), FK_OVERALL_RATING INTEGER, CURRENT_STOCK INTEGER, AVAILABLE INTEGER, SETUP_DATE DATE, DEACTIVATION_DATE DATE, FK_CURRENCY INTEGER, FK_AMOUNT_TYPE INTEGER, CUR_NEWS_FEED TIMESTAMP)");
		...
		db.executeSQL("CREATE TABLE TEST.USERD(IDUSER INTEGER NOT NULL , FIRST_NAME VARCHAR(45) NOT NULL , LAST_NAME VARCHAR(45) NOT NULL , USERNAME VARCHAR(45) NOT NULL , FK_USERTYPE INTEGER NOT NULL , FK_TITLE INTEGER NOT NULL , FK_ADDRESS INTEGER, FK_FARM INTEGER, FK_BARNBAY INTEGER, EMAIL_ADDRESS VARCHAR(100) NOT NULL , PASSWORDHASH VARCHAR(100), SALT VARCHAR(18), SESSION VARCHAR(25), CUR_NEWS_FEED TIMESTAMP)");
		...
		db.executeSQL("CREATE TABLE TEST.BARNBAY (IDBARNBAY INTEGER NOT NULL , NAME VARCHAR(50) NOT NULL , PICTURE VARCHAR(256), DESCRIPTION VARCHAR(256), OPENING_HOURS VARCHAR(100), FK_ADDRESS INTEGER NOT NULL, CUR_NEWS_FEED TIMESTAMP)");
		...
		db.executeSQL("INSERT INTO TEST.BARNBAY(IDBARNBAY, NAME, DESCRIPTION, OPENING_HOURS, FK_ADDRESS, CUR_NEWS_FEED) VALUES(1, 'Barnbay am Schloss', 'Unser original Barnbay am Schloss', 'Montag-Sonntag von 7:00 bis 10:00', 4, '" + GetCurrentTimestamp.getTimestamp() + "')");
		db.executeSQL("INSERT INTO TEST.BARNBAY(IDBARNBAY, NAME, DESCRIPTION, OPENING_HOURS, FK_ADDRESS, CUR_NEWS_FEED) VALUES(2, 'Barnbay am HBF Mannheim', 'Naechster Halt: Barnbay!', 'Montag-Sonntag von 7:00 bis 10:00', 5, '" + GetCurrentTimestamp.getTimestamp() + "')");
		db.executeSQL("INSERT INTO TEST.BARNBAY(IDBARNBAY, NAME, DESCRIPTION, OPENING_HOURS, FK_ADDRESS, CUR_NEWS_FEED) VALUES(3, 'Barnbay@SAP', 'Perfekt fuer SAP-Mitarbeiter', 'Montag-Sonntag von 7:00 bis 10:00', 6, '" + GetCurrentTimestamp.getTimestamp() + "')");
		...
		db.executeSQL("INSERT INTO TEST.PRODUCT(IDPRODUCT, PRODUCT_DESCRIPTION, FK_CATEGORY,"
          		 + "FK_USER, PRICE, CURRENT_STOCK, FK_CURRENCY, FK_AMOUNT_TYPE, CUR_NEWS_FEED) VALUES(1,"
           	 + "'You will love this Product.', 4, 1, 2, 100, 0, 0, '" + GetCurrentTimestamp.getTimestamp() + "')");
		
		db.executeSQL("INSERT INTO TEST.PRODUCT(IDPRODUCT, PRODUCT_DESCRIPTION, FK_CATEGORY,"
         		 + "FK_USER, PRICE, CURRENT_STOCK, FK_CURRENCY, FK_AMOUNT_TYPE, CUR_NEWS_FEED) VALUES(2,"
          	 + "'Best Product in my stock.', 4, 2, 1, 20, 0, 0, '" + GetCurrentTimestamp.getTimestamp() + "')");
		 ...
		 */
		db.executeSQL("INSERT INTO TEST.PRODUCT(IDPRODUCT, PRODUCT_DESCRIPTION, FK_CATEGORY,"
          		 + "FK_USER, PRICE, CURRENT_STOCK, FK_CURRENCY, FK_AMOUNT_TYPE, CUR_NEWS_FEED) VALUES(3,"
           	 + "'You will love this Product.', 5, 1, 2, 100, 0, 0, '" + GetCurrentTimestamp.getTimestamp() + "')");
		
		db.executeSQL("INSERT INTO TEST.PRODUCT(IDPRODUCT, PRODUCT_DESCRIPTION, FK_CATEGORY,"
         		 + "FK_USER, PRICE, CURRENT_STOCK, FK_CURRENCY, FK_AMOUNT_TYPE, CUR_NEWS_FEED) VALUES(4,"
          	 + "'Best Product in my stock.', 5, 2, 3, 20, 0, 0, '" + GetCurrentTimestamp.getTimestamp() + "')");
		 ...
		 */
		db.executeSQL("INSERT INTO TEST.PRODUCT(IDPRODUCT, PRODUCT_DESCRIPTION, FK_CATEGORY,"
           		 + "FK_USER, PRICE, CURRENT_STOCK, FK_CURRENCY, FK_AMOUNT_TYPE, CUR_NEWS_FEED) VALUES(5,"
            	 + "'You will love this Product.', 6, 1, 3, 100, 0, 0, '" + GetCurrentTimestamp.getTimestamp() + "')");
		
		db.executeSQL("INSERT INTO TEST.PRODUCT(IDPRODUCT, PRODUCT_DESCRIPTION, FK_CATEGORY,"
          		 + "FK_USER, PRICE, CURRENT_STOCK, FK_CURRENCY, FK_AMOUNT_TYPE, CUR_NEWS_FEED) VALUES(6,"
           	 + "'Best Product in my stock.', 6, 2, 4, 20, 0, 0, '" + GetCurrentTimestamp.getTimestamp() + "')");
		
		/**
		 * Initialize tomato
		 */
		db.executeSQL("INSERT INTO TEST.PRODUCT(IDPRODUCT, PRODUCT_DESCRIPTION, FK_CATEGORY,"
          		 + "FK_USER, PRICE, CURRENT_STOCK, FK_CURRENCY, FK_AMOUNT_TYPE, CUR_NEWS_FEED) VALUES(7,"
           	 + "'You will love this Product.', 7, 1, 4, 100, 0, 0, '" + GetCurrentTimestamp.getTimestamp() + "')");
		
		db.executeSQL("INSERT INTO TEST.PRODUCT(IDPRODUCT, PRODUCT_DESCRIPTION, FK_CATEGORY,"
         		 + "FK_USER, PRICE, CURRENT_STOCK, FK_CURRENCY, FK_AMOUNT_TYPE, CUR_NEWS_FEED) VALUES(8,"
          	 + "'Best Product in my stock.', 7, 2, 5, 20, 0, 0, '" + GetCurrentTimestamp.getTimestamp() + "')");
